!function (e, t) {
    ...
    return function (e) {
        ...
        var r = n(1), o = n.n(r), i = function (e) {
            ...
            }, c = "TYPE_CHARACTER", l = "REMOVE_CHARACTER", p = "REMOVE_ALL", d = "REMOVE_LAST_VISIBLE_NODE",
            f = "PAUSE_FOR", v = "CALL_FUNCTION", h = "ADD_HTML_TAG_ELEMENT", m = "CHANGE_DELETE_SPEED",
            y = "CHANGE_DELAY", g = "CHANGE_CURSOR", w = "PASTE_STRING", E = "HTML_TAG", T = "TEXT_NODE";
        ...
        var C = function () {
            function e(t, n) {
                ...
                if (function (e, t) {
                    ...
                    if (e) {
                        var n = u.options || {}, r = n.stringSplitter, o = "function" == typeof r ? r(e) : e.split("");
                    ...
                    var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], r = u.options.loop;
                    ...
                    var e = Date.now(), t = e - u.state.lastFrameTime;
                    ...
                    if (u.state.eventLoop = o()(u.runEventLoop), !u.state.eventLoopPaused) {
                        ...
                        var n = S(u.state.eventQueue), r = n.shift(), i = 0;
                        if (!(t <= (i = r.eventName === d || r.eventName === l ? "natural" === u.options.deleteSpeed ? s(40, 80) : u.options.deleteSpeed : "natural" === u.options.delay ? s(120, 160) : u.options.delay))) {
                            var a = r.eventName, b = r.eventArgs;
                            switch (u.logInDevMode({currentEvent: r, state: u.state, delay: i}), a) {
                                case w:
                                case c:
                                    var _ = b.character, O = b.node, C = document.createTextNode(_);
                                ...
                                case f:
                                    ...
                                    break;
                                case v:
                                    var L = r.eventArgs, M = L.cb, D = L.thisArg;
                                    M.call(D, {elements: u.state.elements});
                                    break;
                                case h:
                                    var j = r.eventArgs, P = j.node, x = j.parentNode;
                                    ...
                                    break;
                                case p:
                                    var k = u.state.visibleNodes, Q = b.speed, R = [];
                                    Q && R.push({eventName: m, eventArgs: {speed: Q, temp: !0}});
                                ...
                                case d:
                                    ...
                                    if (u.state.visibleNodes.length) {
                                        var U = u.state.visibleNodes.pop(), q = U.type, G = U.node;
